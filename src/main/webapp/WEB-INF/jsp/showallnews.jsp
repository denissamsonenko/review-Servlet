				...
				<div class="news__row">
					...
					<div class="news__list">
					 <div class="news__info">  
						 <form action="controller" method="post" onsubmit="deleteName(this);return false;" class="news__info">
						<input type="hidden" name="command" value="DELETE_NEWS">
 							 <c:forEach var="news" items="${requestScope.newsList}"> 
								...
								<div class="news__navi">
									<div class="news__view"><a href="controller?command=find_by_id&id=${news.id}">${view}</a></div>
									<div class="news__edit"><a href="controller?command=find_for_update&id=${news.id}">${edit}</a></div>
