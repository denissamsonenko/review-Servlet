		...
		<c:choose>
			<c:when test="${param.command == 'create_news'}">
				...
				<input type="hidden" name="command" value="save_news">
					<div class="edit__news">
						...
						<input class="edit__textbox1" type="textbox" placeholder="${title}" name="title" >	
					</div>
					<div class="edit__news">
						<div class="edit__title">${date}</div>
						<input readonly class="edit__textbox2" type="textbox" placeholder="${now}" > 
					</div>
					<div class="edit__news">
						<div class="edit__title">${brief}</div>
						<textarea class="edit__textbox3" wrap="soft" placeholder="${brief}" name="brief"></textarea>
					</div>
					<div class="edit__news">
						<div class="edit__title">${content}</div>
						<textarea class="edit__textbox4" wrap="soft" placeholder="${content}" name="content"></textarea>
					</div>
			...
			<c:when test="${param.command == 'find_for_update'}">
				...
				<input type="hidden" name="id" value="${requestScope.news.id}">
					<div class="edit__news">
						<div class="edit__title">${title}</div>
						<input class="edit__textbox1" type="textbox" value="${requestScope.news.title}" name="title" >	
					</div>
					<div class="edit__news">
						<div class="edit__title">${date}</div>
						<input readonly class="edit__textbox2" type="textbox" placeholder="${now}" > 
